...
static void gfx_run_dl(Gfx* cmd) {
    ...
    for (;;) {
        ...
        case G_MARKER:
        {
            ...
            if (strcmp(dlName, "title_static\\gFileSelWindow1DL") == 0)
            {
                int bp2 = 0;
            }
            if (strcmp(dlName, "title_static\\gFileSelWindow2DL") == 0)
            {
                int bp2 = 0;
            }
            if (strcmp(dlName, "object_link_child\\gLinkChildTorsoNearDL") == 0) {
                int bp2 = 0;
            }
