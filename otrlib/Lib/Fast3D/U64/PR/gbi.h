...
#define	gsDPSetTextureImageOTR(f, s, w, i)	gsSetImage(G_SETTIMGOTR, f, s, w, i)
...
#define gDPSetCombineMode(pkt, a, b)	(0)
...
#define	gsDPLoadTextureBlockOTR(timg, fmt, siz, width, height,		\
		pal, cms, cmt, masks, maskt, shifts, shiftt)		\
									\
	gsDPSetTextureImageOTR(fmt, siz##_LOAD_BLOCK, 1, timg),		\
	gsDPSetTile(fmt, siz##_LOAD_BLOCK, 0, 0, 			\
		G_TX_LOADTILE, 	0 , cmt, maskt,	shiftt, cms, 		\
		masks, shifts),						\
	gsDPLoadSync(),							\
