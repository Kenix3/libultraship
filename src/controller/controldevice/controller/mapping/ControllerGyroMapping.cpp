...
namespace ShipDK {
ControllerGyroMapping::ControllerGyroMapping(ShipDKDeviceIndex shipDKDeviceIndex, uint8_t portIndex, float sensitivity)
    : ControllerInputMapping(shipDKDeviceIndex), mPortIndex(portIndex), mSensitivity(sensitivity) {
