...
namespace ShipDK {
WiiUAxisDirectionToAxisDirectionMapping::WiiUAxisDirectionToAxisDirectionMapping(ShipDKDeviceIndex shipDKDeviceIndex,
                                                                                 uint8_t portIndex, Stick stick,
                                                                                 Direction direction,
                                                                                 int32_t wiiuControllerAxis,
                                                                                 int32_t axisDirection)
    : ControllerInputMapping(shipDKDeviceIndex),
      ControllerAxisDirectionMapping(shipDKDeviceIndex, portIndex, stick, direction), WiiUMapping(shipDKDeviceIndex),
