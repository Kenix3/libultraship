...
// have ref to port (i think we'd have header problem doing this because port includes this to keep a pointer to control
// device) just keeping the port index for now
