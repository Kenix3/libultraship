...
enum DeviceProfileVersion {
    DEVICE_PROFILE_VERSION_0 = 0, DEVICE_PROFILE_VERSION_1 = 1, DEVICE_PROFILE_VERSION_2 = 2 };
...
class Controller {
  public:
    ...
    void SetButtonMapping(int32_t portIndex, int32_t n64bitmask, int32_t scancode);
