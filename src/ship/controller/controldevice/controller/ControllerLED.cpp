...
void ControllerLED::SaveLEDMappingIdsToConfig() {
    ...
    if (ledMappingIdsCvarKey == "") {
        Ship::Context::GetInstance()->GetChild<ConsoleVariable>()->ClearVariable(ledMappingIdsCvarKey.c_str());
    } else {
        Ship::Context::GetInstance()->GetChild<ConsoleVariable>()->SetString(ledMappingIdsCvarKey.c_str(),
...
void ControllerLED::ReloadAllMappingsFromConfig() {
    ...
    std::stringstream ledMappingIdsStringStream(
        Ship::Context::GetInstance()->GetChild<ConsoleVariable>()->GetString(ledMappingIdsCvarKey.c_str(), ""));
