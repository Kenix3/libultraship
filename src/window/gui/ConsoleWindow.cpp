...
int32_t ConsoleWindow::ClearCommand(std::shared_ptr<Console> console, const std::vector<std::string>& args,
                                    std::string* output) {
    auto window = std::static_pointer_cast<ShipDK::ConsoleWindow>(
...
void ConsoleWindow::InitElement() {
    ...
    Context::GetInstance()->GetConsole()->AddCommand(
        "set", { SetCommand,
                 ...
                 { { "varName", ShipDK::ArgumentType::TEXT }, { "varValue", ShipDK::ArgumentType::TEXT } } });
    Context::GetInstance()->GetConsole()->AddCommand(
        "get", { GetCommand, "Bind key as a bool toggle", { { "varName", ShipDK::ArgumentType::TEXT } } });
    ...
    Context::GetInstance()->GetConsole()->AddCommand(
        "bind", { BindCommand,
                  ...
                  { { "key", ShipDK::ArgumentType::TEXT }, { "cmd", ShipDK::ArgumentType::TEXT } } });
    Context::GetInstance()->GetConsole()->AddCommand(
