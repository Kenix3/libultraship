...
SceneCommand* SceneV0::ParseSceneCommand(BinaryReader* reader) {
    ...
    switch (cmdID) {
        case SceneCommandID::SetStartPositionList:
            return new SetStartPositionList(reader);
        case SceneCommandID::SetActorList:
            return new SetActorList(reader);
        case SceneCommandID::SetTransitionActorList:
            return new SetTransitionActorList(reader);
        case SceneCommandID::SetWind:
            return new SetWind(reader);
        case SceneCommandID::SetTimeSettings:
            return new SetTimeSettings(reader);
        case SceneCommandID::SetSkyboxModifier:
            return new SetSkyboxModifier(reader);
        case SceneCommandID::SetEchoSettings:
            return new SetEchoSettings(reader);
        case SceneCommandID::SetSoundSettings:
            return new SetSoundSettings(reader);
        case SceneCommandID::SetSkyboxSettings:
            return new SetSkyboxSettings(reader);
        case SceneCommandID::SetRoomBehavior:
            return new SetRoomBehavior(reader);
        case SceneCommandID::SetCsCamera:
            return new SetCsCamera(reader);
        case SceneCommandID::SetMesh:
            return new SetMesh(reader);
        case SceneCommandID::SetCameraSettings:
            return new SetCameraSettings(reader);
        case SceneCommandID::SetLightingSettings:
            return new SetLightingSettings(reader);
        case SceneCommandID::SetLightList:
            return new SetLightList(reader);
        case SceneCommandID::SetRoomList:
            return new SetRoomList(reader);
        case SceneCommandID::SetCollisionHeader:
            return new SetCollisionHeader(reader);
        case SceneCommandID::SetEntranceList:
            return new SetEntranceList(reader);
        case SceneCommandID::SetSpecialObjects:
            return new SetSpecialObjects(reader);
        case SceneCommandID::SetObjectList:
            return new SetObjectList(reader);
        case SceneCommandID::SetAlternateHeaders:
            return new SetAlternateHeaders(reader);
        case SceneCommandID::SetExitList:
            return new ExitList(reader);
        case SceneCommandID::SetCutscenes:
            return new SetCutscenes(reader);
        case SceneCommandID::SetPathways:
            return new SetPathways(reader);
        case SceneCommandID::EndMarker:
            return new EndMarker(reader);
        default:
