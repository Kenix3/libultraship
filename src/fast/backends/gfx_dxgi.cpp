...
static LRESULT CALLBACK gfx_dxgi_wnd_proc(HWND h_wnd, UINT message, WPARAM w_param, LPARAM l_param) {
    ...
    switch (message) {
        ...
        case WM_DROPFILES:
            ...
            Ship::Context::GetInstance()->GetChild<Ship::FileDropMgr>()->SetDroppedFile(fileName);
            break;
...
void GfxWindowBackendDXGI::SwapBuffersBegin() {
    ...
    mVsyncEnabled = Ship::Context::GetInstance()->GetChild<Ship::ConsoleVariable>()->GetInteger(CVAR_VSYNC_ENABLED, 1) ? 1 : 0;
