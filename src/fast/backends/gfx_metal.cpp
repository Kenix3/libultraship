...
void GfxRenderingAPIMetal::DrawLines(float buf_vbo[], size_t buf_vbo_len, size_t buf_vbo_num_lines) {
    NS::AutoreleasePool* autorelease_pool = NS::AutoreleasePool::alloc()->init();
    ...
    current_framebuffer.mCommandEncoder->drawPrimitives(MTL::PrimitiveTypeLine, 0.f, buf_vbo_num_lines * 2);
    mCurrentVertexBufferOffset += sizeof(float) * buf_vbo_len;
