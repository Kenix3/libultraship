...
struct GfxRenderingAPI {
    ...
    struct ShaderProgram* (*create_and_load_new_shader)(uint64_t shader_id0, uint64_t shader_id1);
    struct ShaderProgram* (*lookup_shader)(uint64_t shader_id0, uint64_t shader_id1);
