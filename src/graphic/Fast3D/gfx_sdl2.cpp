...
static void gfx_sdl_init(const char* game_name, const char* gfx_api_name, bool start_in_fullscreen, uint32_t width,
    ...
    if (use_opengl) {
        ...
        LUS::Context::GetInstance()->GetWindow()->SetWindowBackend(LUS::WindowBackend::SDL_OPENGL);
    } else {
        ...
        LUS::Context::GetInstance()->GetWindow()->SetWindowBackend(LUS::WindowBackend::SDL_METAL);
    }
