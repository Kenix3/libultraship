...
class GfxBackend {
  ...
  virtual void SetKeyboardCallbacks(bool (*on_key_down)(int scancode), bool (*on_key_up)(int scancode),
                                   void (*on_all_keys_up)()) = 0;
  virtual void SetMouseCallbacks(bool (*on_mouse_button_down)(int btn), bool (*on_mouse_button_up)(int btn)) = 0;
  virtual void SetFullscreenChangedCallback(void (*on_fullscreen_changed)(bool is_now_fullscreen)) = 0;
