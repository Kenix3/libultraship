...
class Fast3dGui : public Ship::Gui {
  public:
     ...
     */
    void LoadGuiTexture(const std::string& name, const std::string& path, std::string& palettePath = "", const ImVec4& tint = ImVec4(1.0f, 1.0f, 1.0f, 1.0f));
     ...
     */
    void LoadGuiTexture(const std::string& name, const Fast::Texture& tex, std::string& palettePath = "", const ImVec4& tint = ImVec4(1.0f, 1.0f, 1.0f, 1.0f));
