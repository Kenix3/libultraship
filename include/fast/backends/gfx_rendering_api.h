...
<<<<<<< Updated upstream
    virtual void DrawPrimitves(float buf_vbo[], size_t buf_vbo_len, size_t buf_vbo_num_prims) = 0;
=======
    virtual void DrawPrimitives(float buf_vbo[], size_t buf_vbo_len, size_t buf_vbo_num_prims) = 0;
>>>>>>> Stashed changes
    virtual void Init() = 0;
