...
#define gsSP1TriangleOTR(v0, v1, v2, flag) { _SHIFTL(G_TRI1_OTR, 24, 8) | __gsSP1Triangle_w1f(v0, v1, v2, flag), 0 }
...
#define gsDma0p(c, s, l) { _SHIFTL((c), 24, 8) | _SHIFTL((l), 0, 24), (uintptr_t)(s) }
...
#define gsImmp1(c, p0) { _SHIFTL((c), 24, 8), (uintptr_t)(p0) }
...
#define gsSPInvalidateTexCache() { _SHIFTL(G_INVALTEXCACHE, 24, 8), 0 }
